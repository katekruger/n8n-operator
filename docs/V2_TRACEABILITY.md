...
| Notification delivery: at-least-once, dedup, bounded retry, content-free | AC-41 | `tests/unit/test_notification_sink.py`, `tests/integration/test_quorum_approval.py::test_notification_payload_never_carries_the_operations_own_argument_value` | [ADR-018](adr/ADR-018-notification-and-alert-hook-delivery.md) | 05, 08 | done |
