...
@pytest.mark.unit
def test_taxonomy_has_exactly_29_codes() -> None:
    """24 original v1 codes, the 3 environment codes stage 04 adds, the 1 approval
    code stage 05 adds, and the 1 retry code stage 06 adds."""
    assert len(TAXONOMY) == 29
